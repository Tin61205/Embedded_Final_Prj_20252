...
3. **Tính năng bổ sung:**
   ...
   - **Âm thanh (Buzzer):** Tích hợp còi chủ động (Active Buzzer TMB12A05, Active Low) phát tiếng "waka", hiệu ứng ăn điểm, mất mạng, nhạc thắng/thua và click menu.
...
| 3 | **Thành viên C** | - Thiết kế và lập trình giao diện Menu điều khiển, quản lý trạng thái chuyển tiếp game (`menu.c`).<br>- Tích hợp High Score view và hỗ trợ 2P mode.<br>- Đấu nối + driver Joystick analog (ADC), Active Buzzer TMB12A05, nút bấm vật lý.<br>- Soạn thảo báo cáo và làm slide thuyết trình. | Hoàn thành |
...
7. **Còi chíp chủ động Active Buzzer TMB12A05 (PC9):**
   - *Tác dụng:* Phát âm thanh hiệu ứng và giai điệu phản hồi cho người chơi. Còi hoạt động ở mức logic thấp (Active Low), được bật/tắt bằng cách cấu hình chân PC9 ở mức LOW hoặc HIGH.
...
graph TD
    ...
    subgraph "Nút bấm & Âm thanh"
        ...
        BUZZ["Active Buzzer TMB12A05<br>PC9 (Active Low)"] --> STM32
    end
...
| **Active Buzzer** | `PC9` | GPIO (Active Low) | Âm thanh hiệu ứng |
...
graph TD
    ...
    subgraph "TẦNG THƯ VIỆN BẢNG MẠCH (Utility Board Library - ub_lib)"
        ...
        UB_Buzzer["stm32_ub_buzzer.c / .h<br>(Active Low + non-blocking)"]
