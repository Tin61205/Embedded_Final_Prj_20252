...
- **Thuật toán:**
  ...
  - Nếu $d^2 \le 64$: chạy về **scatter point** của Clyde — góc dưới bên trái bản đồ $(0, ROOMCNTY - 1)$ qua `bot_calc_move_scatter()`.
...
Pacman trong Campaign dùng tốc độ **cố định 28 ms** ở mọi cấp độ (`CampaignPlayerSpeedMs[10]`). Độ khó tăng chủ yếu nhờ tốc độ Ghost và chiến thuật AI.
...
| ------ | ------------------------ | ------------------------------------------------------- | -------------------- | ------------- | --------------------------------------------------------------------------------------------------------------- |
| **1**  | 4                        | **Lazy** / **Lazy** / **Lazy** / **Lazy**               | 34 ms                | 28 ms         | **Siêu dễ:** Đủ 4 Ghost nhưng tất cả rình rập (chỉ đuổi trong bán kính 6 ô). Làm quen bản đồ và đám đông Ghost. |
| **2**  | 4                        | **Drunk** / **Drunk** / **Drunk** / **Drunk**           | 33 ms                | 28 ms         | **Dễ:** 4 Ghost lang thang ngẫu nhiên — khó bị vây nhưng vẫn gây áp lực tâm lý.                                 |
| **3**  | 3 (Blinky, Pinky, Clyde) | **Lazy** / **Drunk** / — / **Drunk**                    | 32 ms                | 28 ms         | **Dễ vừa:** Giảm còn 3 Ghost; 1 rình rập + 2 gây nhiễu ngẫu nhiên.                                              |
| **4**  | 4                        | **Lazy** / **Drunk** / **Lazy** / **Drunk**             | 31 ms                | 28 ms         | **Trung bình −:** Trở lại đủ 4 Ghost với mix Lazy/Drunk xen kẽ.                                                 |
| **5**  | 3 (Blinky, Pinky, Clyde) | **Chase** / **Drunk** / — / **Lazy**                    | 30 ms                | 28 ms         | **Trung bình:** Blinky đuổi trực tiếp, kết hợp Lazy rình rập và Drunk gây nhiễu.                                |
| **6**  | 3 (Blinky, Inky, Clyde)  | **Chase** / — / **Tricky** / **Lazy**                   | 29 ms                | 28 ms         | **Trung bình +:** Inky bắt đầu vây ráp phối hợp với Blinky.                                                     |
| **7**  | 4                        | **Lazy** / **Lazy** / **Tricky** / **Shy**              | 28 ms                | 28 ms         | **Khó −:** Đủ 4 Ghost; áp lực cao nhưng 2 Lazy giảm độ hung hãn.                                                |
| **8**  | 4                        | **Chase** / **Ambush** / **Lazy** / **Shy**             | 27 ms                | 28 ms         | **Khó:** Pinky chặn đầu + Blinky bám đuôi tạo gọng kìm.                                                         |
| **9**  | 4                        | **Chase** / **Ambush** / **Tricky** / **Shy**           | 26 ms                | 28 ms         | **Cực khó:** Cấu hình AI chuẩn Pac-Man gốc — cả 4 chiến thuật tối ưu.                                           |
| **10** | 4                        | **Chase** / **Ambush** / **Tricky** / **Shy**           | 24 ms                | 28 ms         | **Ác mộng:** Cùng AI cấp 9 nhưng Ghost nhanh nhất (24 ms).                                                      |
