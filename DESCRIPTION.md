...
Ngoài tốc độ Ghost (delay riêng từng cấp), Pacman cũng được tăng tốc theo `Level[]`:
...
|:---:|:---:|---|:---:|:---:|---|
| **1** | 1 (Clyde) | — / — / — / **Drunk** | 80 ms | 30 ms | **Siêu dễ:** 1 Ghost lang thang ngẫu nhiên, rất chậm. Làm quen bản đồ. |
| **2** | 1 (Blinky) | **Lazy** / — / — / — | 70 ms | 26 ms | **Dễ:** Rình rập trong bán kính 6 ô, còn lại đi ngẫu nhiên. |
| **3** | 2 (Blinky, Clyde) | **Lazy** / — / — / **Drunk** | 65 ms | 22 ms | **Dễ vừa:** 1 Ghost gây nhiễu ngẫu nhiên + 1 Ghost rình rập. |
| **4** | 2 (Blinky, Clyde) | **Lazy** / — / — / **Shy** | 60 ms | 18 ms | **Trung bình −:** Clyde chuẩn (đuổi xa, chạy gần) phối hợp Lazy. |
| **5** | 3 (Blinky, Pinky, Clyde) | **Chase** / **Drunk** / — / **Lazy** | 55 ms | 14 ms | **Trung bình:** Blinky đuổi trực tiếp, kết hợp Lazy rình rập và Drunk gây nhiễu. |
| **6** | 3 (Blinky, Inky, Clyde) | **Chase** / — / **Tricky** / **Lazy** | 50 ms | 10 ms | **Trung bình +:** Inky bắt đầu vây ráp phối hợp với Blinky. |
| **7** | 4 | **Lazy** / **Lazy** / **Tricky** / **Shy** | 45 ms | 10 ms | **Khó −:** Đủ 4 Ghost; áp lực cao nhưng 2 Lazy giảm độ hung hãn. |
| **8** | 4 | **Chase** / **Ambush** / **Lazy** / **Shy** | 40 ms | 10 ms | **Khó:** Pinky chặn đầu + Blinky bám đuôi tạo gọng kìm. |
| **9** | 4 | **Chase** / **Ambush** / **Tricky** / **Shy** | 32 ms | 10 ms | **Cực khó:** Cấu hình AI chuẩn Pac-Man gốc — cả 4 chiến thuật tối ưu. |
| **10** | 4 | **Chase** / **Ambush** / **Tricky** / **Shy** | 24 ms | 10 ms | **Ác mộng:** Cùng AI cấp 9 nhưng Ghost nhanh nhất (24 ms). Thử thách nằm ở phối hợp 4 Ghost và tốc độ Ghost tối đa — Pacman vẫn nhanh hơn (10 ms) nên người chơi phải tận dụng tốc độ và xử lý góc cua chính xác. |