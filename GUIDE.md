...
1. **4 nút GPIO** (PC2–PC5)
2. **Joystick analog** (PA1/PA2)
3. **Touch D-pad** trên màn hình
...
2. Hoặc sử dụng **touch D-pad** trên màn hình để đi xuống.
...
6. UB_Joystick_Init()     → PA1/PA2 ADC1 (nếu bật)
7. UB_LCD_Init()          → SPI5 + ILI9341 + SDRAM + LTDC
8. gui_clear_screen()
```
...
3. Nếu không gạt joystick → dùng **touch D-pad** (góc phải dưới màn hình)
