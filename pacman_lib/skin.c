...
Skin_t Ghost_Skin[4][GHOST_SKIN_CNT];
...
//--------------------------------------------------------------
// init skin tables for AI ghost slots (sprite-sheet rows)
//--------------------------------------------------------------
void skin_init_ghosts(void) {
    uint32_t slot;
    uint32_t n;
    static const uint16_t row_y[4] = { 68, 82, 96, 110 };

    for (slot = 0; slot < 4; slot++) {
        for (n = 0; n < GHOST_SKIN_CNT; n++) {
            Ghost_Skin[slot][n].xp = 0;
            Ghost_Skin[slot][n].yp = 0;
        }

        Ghost_Skin[slot][GHOST_SKIN_RIGHT1].xp = 2;
        Ghost_Skin[slot][GHOST_SKIN_RIGHT1].yp = row_y[slot];
        Ghost_Skin[slot][GHOST_SKIN_RIGHT2].xp = 2 + (1 * BOTS_WIDTH);
        Ghost_Skin[slot][GHOST_SKIN_RIGHT2].yp = row_y[slot];
        Ghost_Skin[slot][GHOST_SKIN_LEFT1].xp = 2 + (2 * BOTS_WIDTH);
        Ghost_Skin[slot][GHOST_SKIN_LEFT1].yp = row_y[slot];
        Ghost_Skin[slot][GHOST_SKIN_LEFT2].xp = 2 + (3 * BOTS_WIDTH);
        Ghost_Skin[slot][GHOST_SKIN_LEFT2].yp = row_y[slot];
        Ghost_Skin[slot][GHOST_SKIN_UP1].xp = 2 + (4 * BOTS_WIDTH);
        Ghost_Skin[slot][GHOST_SKIN_UP1].yp = row_y[slot];
        Ghost_Skin[slot][GHOST_SKIN_UP2].xp = 2 + (5 * BOTS_WIDTH);
        Ghost_Skin[slot][GHOST_SKIN_UP2].yp = row_y[slot];
        Ghost_Skin[slot][GHOST_SKIN_DOWN1].xp = 2 + (6 * BOTS_WIDTH);
        Ghost_Skin[slot][GHOST_SKIN_DOWN1].yp = row_y[slot];
        Ghost_Skin[slot][GHOST_SKIN_DOWN2].xp = 2 + (7 * BOTS_WIDTH);
        Ghost_Skin[slot][GHOST_SKIN_DOWN2].yp = row_y[slot];

        Ghost_Skin[slot][GHOST_SKIN_FRIGHTEN1].xp = 3 + (8 * BOTS_WIDTH);
        Ghost_Skin[slot][GHOST_SKIN_FRIGHTEN1].yp = 69;
        Ghost_Skin[slot][GHOST_SKIN_FRIGHTEN2].xp = 3 + (8 * BOTS_WIDTH);
        Ghost_Skin[slot][GHOST_SKIN_FRIGHTEN2].yp = 83;
        Ghost_Skin[slot][GHOST_SKIN_DEAD].xp = 3 + (8 * BOTS_WIDTH);
        Ghost_Skin[slot][GHOST_SKIN_DEAD].yp = 98;
    }
}
